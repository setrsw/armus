...
# coding=utf-8
from sqlalchemy import Column, String, DATETIME, event, create_engine
...
class Seed(Base):
    ...
    def set_init_data(self,db):
        ...
        scut_se=Seed(start_url='http://www2.scut.edu.cn/sse/xshd/list.htm',college='华南理工大学软件学院',
                ...
                text_xpath='//*[@id="page-content-wrapper"]/div[2]/div/div/div[2]/div/div/div/div[2]/div/div')
        ...
        scau_info=Seed(start_url= 'https://info.scau.edu.cn/3762/list.htm',
                  ...
                  # venue= '地点:',
                  # time= '时间:',
                   text_xpath='//div[2]/div[2]/div/div[2]/div')
                  # text_xpath= '//div[2]/div[2]/div/div[2]/div//p')
    ...
    # 特殊处理 ----->>清华大学交叉信息研究院
        ...
        sklois=Seed(start_url= 'http://sklois.iie.cas.cn/tzgg/tzgg_16520/',
                    ...
                    notice_time_xpath='',
                     ...
                     # speaker= '报告人:,Speaker:',
                     # venue= '地点:,Place:,Address:',
                     # time= '时间:,Time',
                    text_xpath='//td[@class="nrhei"]')
